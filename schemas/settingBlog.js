export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description: 'Если после того, как вы попытаетесь опубликовать изменения, у вас появится окно с ошибкой, то нажмите "Try". Не пугайтесь, ваши изменения упешно опубликуются.',
      type: 'localeMarkdown',
    },
    {
